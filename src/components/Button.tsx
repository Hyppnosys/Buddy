...
const variantClasses: Record<Variant, string> = {
  primary:
    'bg-(--color-focus) text-white hover:opacity-90 shadow-(--shadow-soft) active:scale-[0.97]',
  secondary:
    'bg-(--color-surface-alt) text-(--color-ink) hover:bg-(--color-border) active:scale-[0.97]',
