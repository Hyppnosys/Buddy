...
export function PoseIllustration({ poseId, view, size = 96 }: PoseIllustrationProps) {
  ...
  // The side view is drawn once and mirrored horizontally to produce the
  // "right" image, so we only need to hand-place coordinates for one side.
